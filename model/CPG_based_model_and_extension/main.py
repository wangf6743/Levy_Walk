# This is the main part of the model. We iterate over the trade-off parameter (alpha),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--steps", type=int, default=60_000, help="steps per control parameter")
